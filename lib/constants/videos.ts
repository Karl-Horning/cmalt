...
export const microsoftTeamsGuideVideo = {
    src: "/videos/microsoft-teams-guide-excerpt.mp4",
    subtitles: "/videos/microsoft-teams-guide-excerpt.vtt",
    poster: "/videos/microsoft-teams-guide-excerpt.png",
};
